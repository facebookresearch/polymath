...
class EngineStrategy(ABC):
    ...
    def set_constraints_prompt(self, prompt) -> None:
        """
        Replaces the current constraint-generation prompt with a new one.

        Args:
            prompt (str): The new prompt to use.
        """
        ...

    def reset_constraints_prompt(self) -> None:
        """
        Resets the constraint prompt to its original (initial) value.
        Useful for rolling back failed prompt revisions.
        """
        ...
    ...
    def data_structure_included(self, constraints: str) -> bool:
        ...
        Args:
            constraints (str): The constraint code generated by the LLM.
    ...
    async def generate_solver_constraints(
        ...
        Args:
            code (str): code generated with the LLM
        Returns:
