...
from agent.logic.agent_v2 import LogicAgent
...
class ZebraBenchmark:
    ...
    async def run(self) -> None:
        ...
        for row_group_index in range(dataset.num_row_groups):
            ...
            for i, task in enumerate(rows):
                model = self.__chat_completion_2 # if i % 2 == 0 else self.__chat_completion_2
    ...
    async def run_task(
        ...
        engine_strategy : EngineStrategy = PrologEngineStrategy(
